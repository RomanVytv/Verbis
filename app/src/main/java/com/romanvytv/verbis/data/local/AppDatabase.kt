...
import com.romanvytv.verbis.data.local.dao.ResultDao
...
@Database(entities = [Word::class, TodayWord::class, Result::class], version = 1)
abstract class AppDatabase : RoomDatabase() {

	abstract fun wordDao(): WordDao
	abstract fun wordResultsDao(): ResultDao
